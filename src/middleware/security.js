/**
 * Security headers for the Viewer Shell (/a/:uuid)
 ...
 * while permitting embedding inside iframes.
 */
export function rawSandboxHeaders(req, res, next) {
  res.setHeader('Content-Type', 'text/html; charset=utf-8');
  res.setHeader('Content-Security-Policy', 'sandbox allow-scripts allow-forms allow-popups allow-modals; default-src * \'unsafe-inline\' \'unsafe-eval\' data: blob:;');
  res.setHeader('X-Content-Type-Options', 'nosniff');
