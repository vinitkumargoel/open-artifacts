...
export const RAW_SANDBOX_HEADERS = {
  ...
  'Content-Security-Policy': "sandbox allow-scripts allow-forms allow-popups allow-modals allow-downloads; frame-ancestors *; default-src * 'unsafe-inline' 'unsafe-eval' data: blob:;",
  'X-Content-Type-Options': 'nosniff',
